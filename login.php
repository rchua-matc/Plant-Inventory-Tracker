<?php
        ...
        if (isset($_POST['submit']))
        {
            ...
            if (!empty($user_username) && !empty($user_password))
            {
                ...
                $query = "SELECT user_id, username FROM users WHERE "
                        . "username = '$user_username' AND password = "
                        . "SHA('$user_password')";
                ...
                if (mysqli_num_rows($data) == 1)
                {
                    ...
                    // vars / cookies, and redirect to the home page
                ...
                {
                    // The username/password are incorrect, set error message
    ...
    // If the session variable is empty, show any error message and
    // the log-in form; otherwise confirm the log-in
...
<form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
    <fieldset>
        ...
        <input type="text" id="username" name="username"
                value="<?php if (!empty($user_username))
